...
First, changing the shape, size or transparency of your points in a scatterplot can have a similar effect as colour can have:
```{r shape}
...
Next to using shape, size and transparency for differnt groups, you can also manually change these in your plot. 
